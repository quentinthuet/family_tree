...
package body Table_De_Hachage is
    ...
    procedure Enregistrer (Table  : in out T_TH;
        ...
        i : Integer; -- Indice du tableau auquel sera inséré l'élément
    ...
    procedure Modifier (Table  : in out T_TH;
        ...
        i : Integer; -- Indice du tableau auquel se trouve l'élément à modifier
    ...
    procedure Supprimer (Table : in out T_TH;
        ...
        i : Integer; -- Indice du tableau auquel se trouve l'élément à supprimer
    ...
    function Element (Table : in T_TH;
        ...
        i : Integer; -- Indice du tableau auquel se trouve l'élément dont on
                     -- cherche la valeur
    ...
    function Taille (Table : in T_TH)
        ...
        t : Integer := 0; -- La taille provisoire de la Table
    ...
    function Est_Cle_Utilisee (Table : in T_TH;
        ...
        Resultat : T_Donnee; -- Permet d'appeler la fonction Element pour
                             -- éventuellement provoqué une exception
